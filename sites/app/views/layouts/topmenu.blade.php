...
<!--                 <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><i class="icon-fixed-width icon-user"></i> {{ Auth::getUser()->username }} ( กลุ่ม: {{ Usernhc::getUserGroupName()->grp_name }} )<b class="caret"></b></a>
                    <ul class="dropdown-menu">
